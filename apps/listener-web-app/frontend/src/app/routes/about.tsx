  ...
  return (
    <div className="mx-auto px-4 py-8">
      <header className="mb-12 text-center">
        ...
        <p className="text-xl text-gray-600">Personalized Podcast Platformの詳細</p>
      </header>

      <div className="max-w-3xl mx-auto">
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4">Personalized Podcast Platformの概要</h2>
          <p className="mb-4">
            Personalized Podcast Platform (PPP) は、AIを活用して個人の興味や好みに合わせたポッドキャストを自動生成するプラットフォームです。
            お好きなRSSや自身のGoogleカレンダー、Gmailを利用して、ユーザーごとにカスタマイズされたコンテンツを提供します。
          </p>
          <p>
            従来のポッドキャストとは異なり、PPPではAIがあなたの思うポッドキャストを生成し続けます。
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>最新情報の自動取り込み</li>
            <li>ユーザーの好みに合わせた番組の作成</li>
            <li>複数のトピックやジャンルに対応</li>
            <li>ポッドキャスト用RSSフィードの作成</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            PPPの利用を開始するには、アカウントを作成し、番組の説明を作成するだけです。
            番組の作成にはAIによる支援も受けることができ舞うs。
